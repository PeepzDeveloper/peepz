<?php
  ...
  class FormPage
  {
    ...
    public function AddCurrency($Name, $Id, $Value = '', $Title = '', $PlaceHolder ='', $HelpBtn = '', $HelpBlock ='', $NewRow = true, $NewCol = true, $EndCol = true, $EndRow = true, $Required = false)
    {
      $Javascript = $Return = '';
      require_once "formfunctions.php";
      If($NewRow)
      ...
      $Return .= "<div class='form-group'>";
      $Return .= MakeCurrency("field[$Name]", $Id, $Javascript, $Value, $Title, $PlaceHolder, $HelpBtn, $HelpBlock, 'form-control', $Required);
      $Return .= "</div>";
      $this->Javascript .= $Javascript;
      $this->Return .= $Return;
