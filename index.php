      ...
      $.magnificPopup.open({
        ...
        $.ajax({
          ...
          success : function(text){
            if (text == "success"){
              document.getElementById('status').innerHTML = '<h2>Hi <font class="top">' + response.name +'</font> Thank you for joining us.<br>Have a look at our <a href="https://www.facebook.com/peepzonline">facebook</a> page for updates</h2>';
            }
            else {
